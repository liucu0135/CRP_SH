...
for set in range(6):
    ...
    s = Sim(num_color=noc[set], num_model=nom[set], num_lanes=nol[set], lane_length=ll[set], capacity=0, VVR_temp=st,cc_file='./csv_files/cost.csv', color_dist_file='./csv_files/total_orders.csv',repeat=10)
...
result.to_csv('result_ccmat10.csv')